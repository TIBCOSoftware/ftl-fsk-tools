...
// buildKOFStores returns the three required FSK stores with their durable templates.
//
...
func buildStore(name string, template map[string]any, diskPersistence string) map[string]any {
	store := map[string]any{
		...
		"message_limit":         0,
		"name":                  name,
		// publisher_settings.mode MUST be store_confirm_send per FSK requirements
...
// buildTemplate builds a durable template per FSK requirements.
