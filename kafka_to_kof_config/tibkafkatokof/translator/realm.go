...
// WriteRealmJSON generates realm.json containing kof.cluster definitions with
// fully configured pserver_sets modeled after the ftl-cluster.json reference.
//
// numPservers determines how many kof clusters to emit (ceil(numPservers/3)):
//
//	numPservers 1–3 → kof.cluster.0  (pservers 1–3)
//	numPservers 4–6 → kof.cluster.0, kof.cluster.1  (pservers 1–3, 4–6)
//	numPservers 7–9 → kof.cluster.0 … kof.cluster.2  (pservers 1–3, 4–6, 7–9)
...
func buildRealm(cfg *BrokerConfig, realmName string, numPservers int, drOpts DROpts) map[string]any {
	...
	return map[string]any{
		...
		"description":          "Generated by tibkafkatokof",
		"product_data":         map[string]any{},
		"server_time":          "",
		"properties":           buildRealmProps(cfg),
		"applications":         []any{},
		"clusters":             clusters,
		"connector_lists":     []any{},
		"destinations":        []any{},
...
func buildRealmProps(cfg *BrokerConfig) map[string]any {
	return map[string]any{
		// Heartbeat / timeout
		...
		"cluster_disk_index_default_value":       true,
...
// buildKOFCluster constructs the kof.cluster.C map per KOF requirements:
//   - cluster name: "kof.cluster.<clusterIdx>"
...
func buildKOFCluster(cfg *BrokerConfig, clusterIdx, numPservers int, drOpts DROpts) map[string]any {
	...
	return map[string]any{
		...
		"description":               fmt.Sprintf("KOF persistence cluster %d — generated by tibkafkatokof", clusterIdx),
		"disk_compact":              true,
