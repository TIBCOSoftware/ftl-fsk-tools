...
// This file is the canonical, line-by-line account of how tibkafkatokof treats
...
func WriteSupportList(w io.Writer, color bool) {
	...
	fmt.Fprintln(w, paint(ansiBold,
		"tibkafkatokof -- Apache Kafka listener/security property support in TIBCO FTL(R) Service for Kafka (FSK)"))
	fmt.Fprintln(w)
